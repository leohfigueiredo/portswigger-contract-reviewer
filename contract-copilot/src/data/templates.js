export const ndaTemplate = `# Mutual Non-Disclosure Agreement

This Mutual Non-Disclosure Agreement (the "Agreement") is made and entered into as of this [Date], by and between:

**[Company A Name]**, a company organized and existing under the laws of [State/Country A], with its principal place of business at [Address A] ("Disclosing Party A" / "Receiving Party A"); and

**[Company B Name]**, a company organized and existing under the laws of [State/Country B], with its principal place of business at [Address B] ("Disclosing Party B" / "Receiving Party B").
...
This Agreement shall commence on the Effective Date and continue for a period of [e.g., two (2) years] (the "Term"), unless terminated earlier as provided herein. The confidentiality obligations shall survive the termination or expiration of this Agreement for a period of [e.g., five (5) years].
...
This Agreement shall be governed by and construed in accordance with the laws of [State/Country of Governing Law], without regard to its conflict of laws principles.
...
Name: [Authorized Signatory Name A]
Title: [Title A]

**[Company B Name]**

By: _________________________
Name: [Authorized Signatory Name B]
Title: [Title B]`;

export const orderFormTemplate = `# Customer Order Form
...
**City, State, Zip:** [Vendor City, State, Zip]
...
|----------|-------------|----------|------------|-------------|
| 1        | [Product/Service 1] | [Quantity 1] | [Unit Price 1] | [Total Price 1] |
| 2        | [Product/Service 2] | [Quantity 2] | [Unit Price 2] | [Total Price 2] |
...
**Notes:** [Any specific payment instructions or terms]

## 5. Delivery Information

**Delivery Address:** [Delivery Address, if different from Customer Address]
**Requested Delivery Date:** [Requested Delivery Date]
**Notes:** [Any specific delivery instructions]

## 6. Acceptance of Terms

By signing below, the Customer agrees to the terms and conditions set forth in this Order Form and any attached or referenced agreements.
...
**Printed Name:** [Vendor Representative Printed Name]
**Date:** [Date]`;
